...
# sounds_collection = get_collection(db_sfxchallenge, "Sounds") # Uncomment these three lines to refresh the sounds
# populate_sounds_collection(sounds_collection) #                 collection after adding new sounds
